...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/auroracoin.conf are parsed in qt/bitcoin.cpp's main()
    ...
    try
    {
        ...
        if (fCommandLine)
        {
            fprintf(stderr, "Error: There is no RPC client functionality in auroracoind anymore. Use the auroracoin-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
